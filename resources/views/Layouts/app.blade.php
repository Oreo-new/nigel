...
<head>
    ...
    <script>
        ...
        })(window,document,'script','dataLayer','GTM-PLDCD92P');
    </script>
...
<body class="font-serif antialiased {{ bodyClass() }}">
    ...
    <noscript>
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PLDCD92P"
    ...
    <footer class="flex mt-4 container px-4 md:px-0 mb-10 md:mb-4 lg:mb-10 mx-auto">
        ...
        <div class="w-full lg:w-4/5">
            <p class="md:pl-4 lg:pl-0 text-sm text-center md:text-left">
                © Copyright {{ now()->year }} 
                <span class="text-red-600 font-bold">NIGEL SOUTHWAY</span>. All Rights Reserved.
            </p>
        </div>
    </footer>
    ...
    <!-- Resize all iframes inside .videoWrap to 100% width -->
    <script>
        document.querySelectorAll('.videoWrap iframe').forEach(function(iframe){
            iframe.width = "100%";
        });
    </script>
</body>
