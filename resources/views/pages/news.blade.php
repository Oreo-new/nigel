                        ...
                        @foreach($allnews  as $item)
                            <div class="article-item w-full mb-3 mt-10">
                                <div class="head border-b border-gray-200">
                                    <h4 class="text-xl font-bold hover:text-red-600 transition-colors "> <a href="news/{{$item->slug ?? ''}} ">{{$item->title ?? 'Untitled'}}</a></h4>
                                    <div class="flex items-center my-2">
                                        ...
                                        <span class="text-sm mr-4">{{ $item->created_at ? \Carbon\Carbon::parse($item->created_at)->format('F j, Y g:i A') : '' }} </span>
