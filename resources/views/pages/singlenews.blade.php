<x-app-layout>
    <div class="w-full">
                            ...
                            <div x-data="{ showReplyForm: false }" class="reply-form">
                                ...
                                <div x-show="showReplyForm">
                                    <div>
                                         ...
                                         <form action="{{route('newscomments') }}" method="POST" class="mt-5 p-8 bg-gray-300">
                                            @csrf
        ...
        <form action="{{route('newscomments') }}" method="POST" class="mt-4 w-full lg:w-4/6 p-8 bg-gray-300">
            @csrf
            <input type="hidden" name="event_id" value="{{ $article->id }}" />
